...
/**
 * Produces an instance of the signer through stream.
 */
var signer = function(publicKey, attributeName, includeSignature, algorithm) {
  var key = publicKey;
  var attributeName = attributeName || 'signature';
  var algorithm = algorithm || 'RSA-SHA256';
  var includeSignature = attributeName || false;
